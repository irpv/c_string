...
START_TEST(strtok_18) {
  char s1[] = "ABOBA1265445665454654654";
  char s2[] = "ABOBA1265445665454654654";
  char s3[] = "ABOBA12";
...
Suite *suite_strtok() {
  Suite *s = suite_create(YELLOW_BG BLACK "s21_strtok" RESET);
  TCase *tc = tcase_create("strcsuite_strtok_tc");
