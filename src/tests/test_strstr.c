...
START_TEST(strstr_10) {
  char s1[] = "76578423";
  char s2[] = "786f77896789s5675t6756e9786r7895ff679d8s7569w956";
  ck_assert_pstr_eq(strstr(s1, s2), s21_strstr(s1, s2));
}
END_TEST
...
START_TEST(strstr_12) {
  char s1[] = "xdxdxdxdxdxxdxdxdxdxddxdxdxdxd";
  char s2[] = "xxdx";
  ck_assert_pstr_eq(strstr(s1, s2), s21_strstr(s1, s2));
}
END_TEST
...
Suite *suite_strstr() {
  Suite *s = suite_create(YELLOW_BG BLACK "s21_strstr" RESET);
  TCase *tc = tcase_create("strcsuite_strstr_tc");
